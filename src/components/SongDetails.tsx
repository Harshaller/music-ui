...
const tracks = [
  { title: "Dreaming", artist: "Dorian Kinsman", src: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3", cover: dreamingImg },
  { title: "Golden Horizon", artist: "Arctic Echo", src: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3", cover: goldenImg },
  { title: "Midnight Groove", artist: "Luna Waves", src: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3", cover: midnightImg },
  { title: "Electric Pulse", artist: "Neon Drive", src: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3", cover: electricImg },
  { title: "Serenity Fields", artist: "Aurora Bloom", src: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3", cover: serenityImg },
  { title: "Cosmic Voyage", artist: "Stellar Drift", src: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3", cover: cosmicImg },
  { title: "Rising Horizon", artist: "Skyline Dreams", src: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3", cover: horizonImg },
];
    ...
    <section className="bg-[#121212] md:bg-transparent rounded-lg p-4 md:p-0">
      <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
        ...
        <div className="flex-1 text-center md:text-left mt-4 md:mt-0">
          ...
          {/* Track Switcher */}
          <div className="mt-6 flex gap-2 md:gap-3 flex-wrap justify-center md:justify-start">
            {tracks.map((track, idx) => (
              <button
                key={idx}
                onClick={() => changeTrack(track)}
                className="px-3 py-1 rounded bg-[#1f1f1f] text-white hover:bg-[#2a2a2a] transition text-xs md:text-sm"
              >
                {track.title}
              </button>
            ))}
